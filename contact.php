...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Food Nepal</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="tel" class="form-control" pattern="[6-9]{1}[0-9]{9}"  name="phone" placeholder="Phone(optinal) EX +97798*******"/>
            </div>
			<div class="form-group">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>9847614821</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; satdobato,peepalbot<br>(24*7 Days)
